...
export default function Home() {
  return (
    <div className="p-8 bg-slate-50 text-slate-900 dark:bg-slate-900 dark:text-slate-100 h-screen flex flex-col items-center text-center"> {/* <div className="max-w-2xl"> */}
...
{/* <div className="max-w-[700px]"> */}
    <div className="max-w-app">
      ...
      <button className="bg-sky-500 dark:bg-[blue] dark:text-sky-950 text-white px-4 py-2 rounded-md font-medium mt-4 enabled:hover:bg-sky-600 disabled:opacity-60 disabled:cursor-not-allowed">
